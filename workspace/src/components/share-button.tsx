...
export default function ShareButton({ slug, time, imageSrc }: ShareButtonProps) {
  ...
  const absoluteImageUrl = new URL(imageSrc, siteUrl).href;
  ...
  const socialLinks = [
    ...
    { name: 'LinkedIn', icon: Linkedin, url: `https://www.linkedin.com/shareArticle?mini=true&url=${encodedUrl}&title=${encodeURIComponent("I solved a Piczzle!")}` },
